(function initPwa() {
  ...
  if (!isStandalone && isIos && !seenHint) {
    window.addEventListener("load", () => {
      ...
      hint.innerHTML =
        "<span>Install ShelfMapper: tap Share, then Add to Home Screen.</span><button type='button' class='pwa-ios-hint-close' aria-label='Dismiss install hint'>Dismiss</button>";
      hint
